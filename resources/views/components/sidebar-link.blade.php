...
>
    ...
    <span
        aria-hidden="true"
        class="absolute start-0 top-1/2 h-5 w-[3px] -translate-y-1/2 rounded-e-full bg-accent-bright {{ $active ? 'opacity-100' : 'opacity-0' }}"
    ></span>
    ...
    @isset($badge)
        <span
            class="ms-auto inline-flex min-w-5 shrink-0 items-center justify-center rounded-full bg-accent-bright px-1.5 py-0.5 font-data text-[0.625rem] font-semibold text-nav-900"
